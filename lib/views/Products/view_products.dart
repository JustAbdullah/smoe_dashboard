...
import 'package:smoe_dashboard/core/data/model/maintype.dart';
                                              ...
                                              child: GetX<HomeController>(
                                                builder: (controller) => FutureBuilder<
                                                    ...
                                                    future: controller
                                                            ...
                                                            true
                                                        ? controller
                                                            .searchingProductsName(
                                                                controller
                                                                    .nameSearching
                                                                    .toString())
                                                        : homeController
                                                            .getDataProductsDatabase(),
                                                    builder:
                                                                          ...
                                                                          child: Row(
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  width: 40.w,
                                                                                  child: TextCustom(theText: products.id, fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                ),
                                                                                SizedBox(
                                                                                  width: 5.w,
                                                                                ),
                                                                                Container(
                                                                                  alignment: Alignment.center,
                                                                                  width: 40.w,
                                                                                  child: TextCustom(theText: products.name, fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                ),
                                                                                SizedBox(
                                                                                  width: 5.w,
                                                                                ),
                                                                                Container(
                                                                                  alignment: Alignment.center,
                                                                                  width: 40.w,
                                                                                  child: TextCustom(theText: products.nameEn, fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                ),
                                                                                SizedBox(
                                                                                  width: 5.w,
                                                                                ),
                                                                                Container(
                                                                                  alignment: Alignment.center,
                                                                                  width: 40.w,
                                                                                  child: TextCustom(theText: products.price, fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                ),
                                                                                SizedBox(
                                                                                  width: 5.w,
                                                                                ),
                                                                                ...
                                                                                InkWell(
                                                                                    onTap: () {
                                                                                      if (homeController.typeOfAdmin.value != 2) {
                                                                                        ...
                                                                                        homeController.idProductsEdit = int.parse(products.id.toString());
                                                                                        ////////////////////مهم جدًا

                                                                                        ///جلب بيانات الصنف الرئيسي;

                                                                                        homeController.idMainTypeEditInProduct = int.parse(products.idType.toString());
                                                                                        homeController.nameArEditProduct = products.name.toString();
                                                                                        homeController.nameEnEditProduct = products.nameEn.toString();
                                                                                        homeController.iconProducEdit = products.img.toString();
                                                                                        homeController.EditProductdescriptionAr = products.about.toString();
                                                                                        homeController.EditProductdescriptionEn = products.aboutEn.toString();
                                                                                        homeController.EditPriceProduct = int.parse(products.price.toString());
