                            ...
                            Align(
                              ...
                              child: PaddingCustom(
                                ...
                                child: TextCustom(
                                    height: 1.5,
                                    theText:
                                        "معلومات واحصائيات شاملة عن  المنتجات المتوفرة في قاعدة البيانات",
                                    fontSizeWidth: 4.sp,
                                    fontWeight: FontWeight.bold,
                                    fontFamily: AppTextStyles.Almarai,
                                                ...
                                                builder: (controller) =>
                                                    FutureBuilder(
                                                        future: controller
                                                                    ...
                                                                    .value ==
                                                                true
                                                            ? controller.searchingProductsName(
                                                                controller
                                                                    .nameSearching
                                                                    .toString())
                                                            : homeController
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                    Container(
                                                                                      ...
                                                                                      width: 40.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['prooduct_id'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
                                                                                    Container(
                                                                                      alignment: Alignment.center,
                                                                                      width: 40.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['prooduct_name_ar'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
                                                                                    Container(
                                                                                      alignment: Alignment.center,
                                                                                      width: 40.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['prooduct_name_en'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
                                                                                    Container(
                                                                                      alignment: Alignment.center,
                                                                                      width: 40.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['products_price'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
                                                                                    InkWell(
                                                                                        onTap: () {
                                                                                          if (homeController.typeOfAdmin.value != 2) {
                                                                                            ...
                                                                                            homeController.ofIdSubTypeDeleteOrEdit = snapshot.data['data'][i]['prooduct_id'].toString();
                                                                                            ////////////////////
                                                                                            homeController.idMainSubTypeEdit = snapshot.data['data'][i]['main_type_id'].toString();
                                                                                            homeController.idSubTypeEdit = snapshot.data['data'][i]['prooduct_id'].toString();
                                                                                            homeController.nameArEditSubType = snapshot.data['data'][i]['prooduct_name_ar'].toString();
                                                                                            homeController.nameEnEditSubType = snapshot.data['data'][i]['prooduct_name_en'].toString();
                                                                                            homeController.iconEditSubType = snapshot.data['data'][i]['products_image'].toString();
                                                                                            homeController.sub_type_description_ar = snapshot.data['data'][i]['prooduct_description_ar'].toString();
                                                                                            homeController.sub_type_description_en = snapshot.data['data'][i]['prooduct_description_en'].toString();
                              ...
                              PaddingCustom(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () {
                                        controller.deleteProducs(controller
